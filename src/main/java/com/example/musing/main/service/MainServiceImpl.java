...
public class MainServiceImpl implements MainService{
    ...
    @Override
    @Transactional
    public MainPageDto.NotLoginMainPageDto notLoginMainPage() { //로그인 하지않는 메인페이지
        ...
        return MainPageDto.NotLoginMainPageDto.builder()
                .noticeDto(noticeDto)
                .recommendGenres(genreBoardDtos)
                .hotMusicBoard(hotMusicBoardDto)
                .recentBoard(mainPageBoardDtos)
                .build();
    }
